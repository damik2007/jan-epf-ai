...
export function SreTelemetryPanel() {
  ...
  return (
    <section className="bg-slate-950 text-white rounded-3xl p-6 sm:p-7 shadow-2xl border border-slate-800 space-y-5 relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-base sm:text-lg font-black tracking-tight text-white">
              Sovereign Operational Health & DPDP Compliance
            </h3>
          </div>
        </div>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs font-bold flex items-center gap-1.5 transition-all text-slate-300 shrink-0"
        >
          <span>{isOpen ? "Collapse SRE Telemetry" : "Expand SRE Telemetry"}</span>
