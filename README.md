...
<div align="center">
  <video src="docs/demo/Jan_EPF_AI_Master_Product_Demo.mp4" controls="controls" width="100%" poster="docs/demo_clips_inspection/clip_1_frame_1.jpg">
  ...
  <p>
    <a href="docs/demo/Jan_EPF_AI_Master_Product_Demo.mp4">
      <img src="https://img.shields.io/badge/▶%EF%B8%8F%20Direct%201080p%20Stream%20with%20Audio-Jan__EPF__AI__Master__Product__Demo.mp4-red?style=for-the-badge&logo=youtube" alt="Play Video" />
    </a>
  </p>
</div>

▶️ **Watch / Download Master MP4 (1080p with Full Sound):** [`docs/demo/Jan_EPF_AI_Master_Product_Demo.mp4`](docs/demo/Jan_EPF_AI_Master_Product_Demo.mp4)  
...
|---|---|---|
| **01** | **FastPath Login Gateway** | ![01 Login](docs/screenshots/01_login_fastpath.png) |
| **02** | **Citizen Dashboard (Discreet Mode Active)** | ![02 Dashboard Privacy](docs/screenshots/02_dashboard_privacy_on.png) |
| **03** | **Citizen Dashboard (Unmasked Live State)** | ![03 Dashboard Unmasked](docs/screenshots/03_dashboard_unmasked.png) |
| **04** | **Command Center Modal (⌘K)** | ![04 Command Center](docs/screenshots/04_command_center_glass.png) |
| **05** | **Sovereign Agent Harness Chat Modal** | ![05 Sovereign Agent Harness](docs/screenshots/05_sovereign_agent_harness_glass.png) |
| **06** | **I Need Money Hub (/money)** | ![06 Money Hub](docs/screenshots/06_need_money_hub.png) |
| **07** | **I Changed Jobs Hub (/career)** | ![07 Career Hub](docs/screenshots/07_career_transfer_hub.png) |
| **08** | **My Savings & Compounding Hub (/savings)** | ![08 Savings Hub](docs/screenshots/08_savings_compounding_hub.png) |
| **09** | **Fix Details Hub (/fix)** | ![09 Fix Hub](docs/screenshots/09_fix_details_hub.png) |
| **10** | **Benchmarks Tab 1: 3-Way Evals Matrix** | ![10 Benchmarks Tab 1](docs/screenshots/10_benchmarks_tab1_latency.png) |
| **11** | **Benchmarks Tab 2: 1,000-Run Latency Runner** | ![11 Benchmarks Tab 2](docs/screenshots/11_benchmarks_tab2_cost.png) |
| **12** | **Benchmarks Tab 3: Raw Token Traces** | ![12 Benchmarks Tab 3](docs/screenshots/12_benchmarks_tab3_evals.png) |
| **13** | **Benchmarks Tab 4: National Exchequer ROI** | ![13 Benchmarks Tab 4](docs/screenshots/13_benchmarks_tab4_cpgrams.png) |
| **14** | **Benchmarks Tab 5: SRE Security Audit** | ![14 Benchmarks Tab 5](docs/screenshots/14_benchmarks_tab5_sre.png) |
| **15** | **Architecture Tab 0: Sovereign Harness Blueprint** | ![15 Architecture Tab 0](docs/screenshots/15_architecture_tab0_harness.png) |
| **16** | **Architecture Tab 1: 1.98M Grievance Root Causes** | ![16 Architecture Tab 1](docs/screenshots/16_architecture_tab1_grievances.png) |
| **17** | **Architecture Tab 2: DPDP Act 2023 Compliance** | ![17 Architecture Tab 2](docs/screenshots/17_architecture_tab2_legal.png) |
| **18** | **Architecture Tab 3: Demographic Personas (70M Workers)**| ![18 Architecture Tab 3](docs/screenshots/18_architecture_tab3_personas.png) |
| **19** | **Architecture Tab 4: 18 Archaic Forms vs 4 Hubs** | ![19 Architecture Tab 4](docs/screenshots/19_architecture_tab4_forms.png) |
